...
namespace ScopeBoxes
{
    ...
    public class Cmd_GridDimensions : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            List<Element> curViewGrids = GetCurrentViewGrids(doc, doc.ActiveView);
        ...
        List<Element> GetCurrentViewGrids(Document doc, View curView)
        {
            var grids = new FilteredElementCollector(doc, curView.Id)
